...
export type AuthUser = Pick<User, "id" | "name" | "email" | "role" | "status" | "avatarUrl" | "birthDate" | "phone" | "address">;
...
export interface UpdateProfileDto { name: string; birthDate?: string; phone?: string; address?: string }
